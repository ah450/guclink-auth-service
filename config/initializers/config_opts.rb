...
Rails.application.config.configurations = {
  error_messages: {
    ...
    incorrect_reset_token: 'Incorrect reset token, token only valid for 24 hours',
    incorrect_verification_token: 'Incorrect verification token. Token only valid for 5 hours',
